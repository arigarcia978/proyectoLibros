...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { estante_libro_id: @rate.estante_libro_id, puntaje: @rate.puntaje, review: @rate.review }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { estante_libro_id: @rate.estante_libro_id, puntaje: @rate.puntaje, review: @rate.review }
    assert_redirected_to rate_path(assigns(:rate))
  end
